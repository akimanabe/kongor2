...
#' Estimate residual for specified means and sds
#'
...
#' @param sds sd of each distribution. vector length must be the same as that of means
#'
...
estim_optim <-
  ...
  optim(ps, calcresid, method = "L-BFGS-B", lower = 0) %>%
    broom::tidy()
}
